...
parser.add_argument('--save_model_path', type=str, default='saved_models/seed_500/', help='the path of trained model file')
...
parser.add_argument('--pose-list', default='./list/pose_train.list', help='list of pose features')
...
parser.add_argument('--test-pose-list', default='./list/pose_test.list', help='list of test audio features')
