...
def send_video(video_path: str, api_url: str = "http://localhost:8000/process") -> None:
    """
    ...
    try:
        ...
        with open(video_path, 'rb') as video_file:
            ...
            if response.status_code == 200:
                ...
                output_dir = 'test_data_api/received'
...
if __name__ == "__main__":
    ...
    video_path = "Processed_Videos/1-1004/A.Beautiful.Mind.2001___00-01-45_00-02-50_label_A.mp4"
